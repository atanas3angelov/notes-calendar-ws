...
- run 2 commands from the main project: <mark style="background-color: #ccc">git submodule</mark> init to initialize your local configuration file, and <mark style="background-color: #ccc">git submodule update</mark> to fetch all the data.  
